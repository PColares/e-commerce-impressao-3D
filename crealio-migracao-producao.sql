-- Crealio: tabelas de produção (impressoras, filamentos carregados, jobs e falhas).
-- Importe no phpMyAdmin, no banco u520460695_kamadadb, DEPOIS do kamada-banco.sql.
-- Gerado a partir de apps/api/prisma/migrations/20260922130000_production_printers/migration.sql.
SET NAMES utf8mb4;
...
INSERT INTO `_prisma_migrations` VALUES ('305d291b-2de1-4be1-921e-a3934adf4cf8', 'c1a0c54bc0acf9e84361ed1768f95454067dfa20b99689d86a401c4cc72f4ecd', CURRENT_TIMESTAMP(3), '20260922130000_production_printers', NULL, NULL, CURRENT_TIMESTAMP(3), 1);
